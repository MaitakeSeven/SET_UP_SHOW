class User < ApplicationRecord
    ...
    validates :name, presence: true, length: { maximum:10,message: '名前は1文字以上10文字以内で入力してください' }
    validates :email, presence: true,length: { maximum:255,message: "メールアドレスの形式が違います。" },
